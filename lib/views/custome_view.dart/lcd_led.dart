    ...
    for (int i = 0; i < lcd.length; i++) {
      ...
      switch (i) {
        ...
        if (lcd[8] == 1) break;
          ...
          path
            ..moveTo(x1, y1 + shapeSpace!)
            ..lineTo(x1, y2 - shapeSpace! / 2)
            ..lineTo(x2, y2 - thickness / 2 - shapeSpace! / 2)
            ..lineTo(x2, thickness + shapeSpace!)
            ..close();
          break;
        case 2:
        if (lcd[8] == 1) break;
          final double x1 = size.width - thickness,
              ...
              y2 = size.height / 2;
          path
            ..moveTo(x1, thickness + shapeSpace!)
            ..lineTo(x2, y1 + shapeSpace!)
            ..lineTo(x2, y2 - shapeSpace! / 2)
            ..lineTo(x1, y2 - thickness / 2 - shapeSpace! / 2)
            ..close();
          break;
        case 3:
        if (lcd[8] == 1) break;
          final double x1 = shapeSpace!,
              y1 = size.height / 2 - thickness / 4,
              x2 = size.width - shapeSpace!,
        ...
        if (lcd[8] == 1) break;
          final double x1 = 0,
              y1 = size.height / 2 + shapeSpace! / 2,
              x2 = thickness,
              y2 = size.height - shapeSpace! / 2;
          path
            ..moveTo(x1, y1)
            ..lineTo(x2, y1 + thickness / 2)
            ..lineTo(x2, y2 - thickness - shapeSpace! / 2)
            ..lineTo(x1, y2)
            ..close();
          break;
        case 5:
        ...
        case 6:
        if (lcd[8] == 1) break;
          final double x1 = shapeSpace! / 2,
              y1 = size.height - thickness,
              x2 = size.width - shapeSpace! / 2,
              y2 = size.height;
          path
        ...
        case 8:
          if (lcd[8] == 0) break;
          final d = size.width * 0.3 > 10.0 ? size.width * 0.3 : 10.0;
          path.addRect(
            Rect.fromCenter(
